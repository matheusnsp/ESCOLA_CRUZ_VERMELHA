...
app.post('/webhook/unicopag', async (req, res) => {
  try {
    ...
    // parcelamento — ex.: amount:1000, amount_total:1060 pra 2x). Usávamos amount_total pro
    // matching de contingência abaixo, e como o banco guarda o valor SEM juros, a comparação
    // nunca casava em compras parceladas ("Pagamento não identificado" mesmo com email certo).
    // amount_total continua sendo o valor real cobrado do cliente, então mantemos ele à parte
    // só pra log/exibição.
